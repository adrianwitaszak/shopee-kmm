...
val AccentMedium = Color(0xFF775782)
val AccentLight = Color(0xFFA67FB3)
val AccentLightBlue = Color(0xFFC6E9F5)

val ShadeRed = Color(0xFFFF1744)
val ShadeGreen = Color(0xFF00E676)
val ShadeYellow = Color(0xFFFFEA00)
val ShadeBlue = Color(0xFF00E5FF)
val ShadePink = Color(0xA3D500F9)
val ShadeViolet = Color(0xFF651FFF)
